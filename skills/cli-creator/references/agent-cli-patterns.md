...
The CLI is an agent's command layer. It should turn a service, app, API, log source, or database into shell commands an agent can run repeatedly from any repo.
...
Include JSON shape notes only when an agent needs them to choose the next command.
